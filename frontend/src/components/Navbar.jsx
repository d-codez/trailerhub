    ...
    >
      <div className="flex items-center justify-between px-4 md:px-12 py-3">
        <div className="flex items-center gap-6 md:gap-10">
          ...
          <svg
            viewBox="0 0 111 30"
            className="h-6 md:h-7 fill-[#E50914] cursor-pointer"
            aria-label="Netflix"
          >
          ...
          <div className="hidden md:flex items-center gap-5">
            <a href="#" className="text-white text-sm font-medium hover:text-gray-300 transition-colors">Home</a>
            <a href="#" className="text-gray-300 text-sm hover:text-white transition-colors">TV Shows</a>
            <a href="#" className="text-gray-300 text-sm hover:text-white transition-colors">Movies</a>
            <a href="#" className="text-gray-300 text-sm hover:text-white transition-colors">New & Popular</a>
            <a href="#" className="text-gray-300 text-sm hover:text-white transition-colors">My List</a>
            <a href="#" className="text-gray-300 text-sm hover:text-white transition-colors">Browse by Languages</a>
          </div>
          ...
          <div className="md:hidden relative">
            ...
            {showDropdown && (
              <div className="absolute top-full left-0 mt-2 bg-black/95 border border-gray-700 rounded py-2 min-w-[200px]">
                ...
                <a href="#" className="block px-4 py-2 text-white hover:bg-gray-800">TV Shows</a>
                <a href="#" className="block px-4 py-2 text-white hover:bg-gray-800">Movies</a>
                <a href="#" className="block px-4 py-2 text-white hover:bg-gray-800">New & Popular</a>
                <a href="#" className="block px-4 py-2 text-white hover:bg-gray-800">My List</a>
              </div>
            )}
          </div>
        </div>
